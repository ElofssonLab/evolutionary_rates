...
#SBATCH -t 1:00:00
#SBATCH --array=1-447
#SBATCH --error=/home/p/pbryant/pfs/results/CATH/20191031/error/%A_%a.error
#SBATCH --output=/home/p/pbryant/pfs/results/CATH/20191031/out/%A_%a.out
...
RESULTS_DIR=/home/p/pbryant/pfs/results/CATH/20191031 #RESULTS DIRECTORY
RUN_DIR=/home/p/pbryant/pfs/runs/CATH/20191031 #RUN DIRECTORY
#Path to git directory
GITDIR=/home/p/pbryant/pfs/evolutionary_rates
#Path to fasta files
FASTADIR=/home/p/pbryant/pfs/data/CATH/complete_flow/topology/fasta
#Get filename from line index
HGROUPS=$RUN_DIR/topology_groupings.txt #This file has to contain the selected newline separated H-groups
...
singularity exec $BIO_IMAGE $GITDIR/get_topology_data.py --input_dir $FASTADIR/$FILE_NAME/ --output_dir $TEMPDIR/ --hhblits $HHBLITS --hhalign $HHALIGN --uniprot $UNIPROT --address $CATH_API
