...
RESULTS_DIR=/home/p/pbryant/pfs/runs/CATH/test/20191031 #RESULTS DIRECTORY
...
FAILED_PDB_FILTER=$RESULTS_DIR'/failed_pdb_filter.txt'
...
#Make sure all directories in all runscripts match the current run
#wait
